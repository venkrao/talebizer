    ...
    <div className="w-full px-4 py-8 pb-24 sm:px-6 lg:px-8 lg:pb-10">
      <header className="mb-8 border-b border-zinc-200 pb-6 dark:border-zinc-800">
        ...
        <p className="mt-2 max-w-xl text-sm text-zinc-600 dark:text-zinc-400">
          ...
          <span className="text-zinc-800 dark:text-zinc-300">System</span>.
        </p>
        <button
          type="button"
        ...
        {refreshM.isError ? (
          <p className="mt-3 rounded border border-red-300 bg-red-50 px-3 py-2 text-sm text-red-800 dark:border-red-900/60 dark:bg-red-950/40 dark:text-red-300">
      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:gap-6 xl:gap-8">
          ...
          <CollapsibleSection title="Portfolio overview">
            {summaryQ.isLoading ? (
              ...
              <>
                ...
                <p className="mt-3 border-t border-zinc-200 pt-2 text-[11px] text-zinc-500 dark:border-zinc-800/80 dark:text-zinc-600">
        ...
        <aside
          className={
            ...
            "flex flex-col overflow-hidden rounded-xl border border-zinc-300 bg-white shadow-lg shadow-zinc-300/30 " +
            "dark:border-zinc-700/90 dark:bg-zinc-900/90 dark:shadow-xl dark:shadow-black/30 " +
        ...
        >
          ...
          <div className="flex min-h-0 flex-1 flex-col gap-3 p-4">
            {capabilitiesQ.data ? (
              <details className="shrink-0 rounded-md bg-zinc-100 p-2 text-xs text-zinc-600 dark:bg-black/25 dark:text-zinc-400">
                <summary className="cursor-pointer text-zinc-800 dark:text-zinc-300">
            ...
            <div className="min-h-[12rem] flex-1 overflow-y-auto rounded-md bg-zinc-100 p-2 dark:bg-black/35 lg:min-h-0">
              {chatLog.length === 0 ? (
                ...
                chatLog.map((m, i) => (
                  <div
                    ...
                    className={`mb-2 rounded px-2 py-1.5 text-xs last:mb-0 ${
                      m.role === "user"
                        ? "ml-4 bg-emerald-100 text-emerald-950 dark:bg-emerald-950/55 dark:text-emerald-100"
                        : "mr-4 bg-zinc-200 text-zinc-900 dark:bg-zinc-800/90 dark:text-zinc-200"
                    }`}
                  >
            ...
            >
              <div className="flex flex-col gap-2 sm:flex-row">
                <input
                  className="min-w-0 flex-1 rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 placeholder:text-zinc-400 focus:border-emerald-600 focus:outline-none dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100 dark:placeholder:text-zinc-600 dark:focus:border-emerald-700"
